 ...
 */
public class PigArcRecord
        implements Writable {

    private static final Logger LOG = Logger.getLogger(PigArcRecord.class);
...
//private String filename;
     ...
     */
    public PigArcRecord(String arcRecordHeader, BytesWritable content)
